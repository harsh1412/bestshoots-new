...
<section id="content">
    ...
    <div id="edit-contest" class="edit-prizes">
        <div class="header">
            ...
            <a href="#" class="button button-small-green js-write-modal" data-modal-id="#js-add-prize-modal">Add a
                prize</a>
        </div>
        <div class="content">
            <div class="empty-content" id="js-empty-content">
                <div>For this contest has no prizes</div>
            </div>
        ...
        <div id="prize-form" class="fs-form fs-form2 js-form">
            ...
            <div class="fs-input">
                ...
                <div class="input">
                    ...
                    <ul id="js-type">
                        <li class="option check js-option" data-type="1"><i class="fa fa-check"></i><span>rating</span>
                        </li>
                ...
                <div class="action">
                    <a href="#" class="button button-small-black" id="js-add-prize" data-type="1"
                       data-contest-id="<?= $id ?>">add</a>
                </div>
