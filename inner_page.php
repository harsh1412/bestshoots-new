    ...
    <div id="project">
        <div class="column about-contest">
            <div class="container">
                ...
                <div class="company-name">by <a href="/company_profile.php?id=<?= $row['col_company_id'] ?>"
                                                class="link"><?= $row['col_company_name'] ?></a></div>
                <div class="text"><?= $row['col_about'] ?></div>
                <div class="action">
                    <a href="#" class="button button-big-black js-write-modal" data-modal-id="#js-about-modal">explore
                        more</a>
                </div>
            </div>
        </div>
        ...
        <div class="column brand-info">
            <div class="container">
                ...
                <a href="/company_profile.php?id=<?= $row['col_company_id'] ?>"><img
                            src="/img/companies/logo/<?= $row['col_avatar'] ?>"></a>
                <div class="company-name"><?= $row['col_company_name'] ?></div>
                <div class="info">
                    <div class="description">
                        <a href="/company_profile.php?id=<?= $row['col_company_id'] ?>"
                           class="tag">@<?= $row['col_company_name'] ?></a>
                        <div class="about" id="js-brand-info-about"><?= $row['col_company_about'] ?></div>
                        <a href="#" class="read js-write-modal" id="js-write-brand-info-about"
                           data-modal-id="#js-brand-about-modal">Read More</a>
                        <?php
                        ...
                        echo '</div>';
                        ?>
                        <div class="date"><i class="fa fa-calendar-o"></i><span>Join <?= $row['col_date'] ?></span>
                        </div>
                    </div>
